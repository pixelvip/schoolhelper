  ...
  render() {
    ...
    switch (this.props.type) {
      ...
      case Modal.types.DeleteOk:
        content[0] = <button key="1" type="button" className="btn btn-light mr-auto" onClick={this.props.deleteHandler}><span className="material-icons md-48">delete</span></button>;
      ...
      case Modal.types.Cancel:
        content[0] = <button key="1" type="button" className="btn btn-light" data-dismiss="modal" onClick={this.props.closeHandler}><span className="material-icons md-48">clear</span></button>;
        break;
      case Modal.types.DeleteEditOk:
        content[0] = <button key="1" type="button" className="btn btn-light" onClick={this.props.deleteHandler}><span className="material-icons md-48">delete</span></button>;
        content[1] = <button key="2" type="button" className="btn btn-light mr-auto" onClick={this.props.editHandler}><span className="material-icons md-48">edit</span></button>
        content[2] = <button key="3" type="button" className="btn btn-light" data-dismiss="modal" onClick={this.props.closeHandler}><span className="material-icons md-48">done</span></button>;
        break;
      default:
